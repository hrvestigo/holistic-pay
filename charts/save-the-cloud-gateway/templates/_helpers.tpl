...
*/}}
{{- define "save-the-cloud-gateway.name" -}}
...
*/}}
{{- define "save-the-cloud-gateway.chart" -}}
...
*/}}
{{- define "save-the-cloud-gateway.trustStoreEnv" -}}
...
{{/*
save-the-cloud-gateway image repository
*/}}
{{- define "save-the-cloud-gateway.app.repository" -}}
{{- if .Values.image.app.imageLocation }}
{{- .Values.image.app.imageLocation }}
{{- else }}
{{- $psRepo := "hrvestigo/save-the-cloud-gateway-ms" }}
...
{{/*
save-the-cloud-gateway image pull policy
*/}}
{{- define "save-the-cloud-gateway.app.imagePullPolicy" -}}
...
Common labels
*/}}
{{- define "save-the-cloud-gateway.labels" -}}
helm.sh/chart: {{ include "save-the-cloud-gateway.chart" . }}
app: {{ include "save-the-cloud-gateway.name" . }}
project: HolisticPay
{{ include "save-the-cloud-gateway.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "save-the-cloud-gateway.selectorLabels" -}}
app.kubernetes.io/name: {{ include "save-the-cloud-gateway.name" . }}
...
Volumes
*/}}
{{- define "save-the-cloud-gateway.volumes" -}}
...
{{/*
Mounts for save-the-cloud-gateway application
*/}}
{{- define "save-the-cloud-gateway.mounts" -}}
...
Application secrets
*/}}
{{- define "save-the-cloud-gateway.passwords" -}}
...
Application logger
*/}}
{{- define "save-the-cloud-gateway.logger" -}}
...
*/}}
{{- define "save-the-cloud-gateway.appConfig" -}}
