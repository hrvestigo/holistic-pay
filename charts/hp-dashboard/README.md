...
`helm upgrade --install hp-dashboard holisticpay/hp-dashboard -f my-values.yaml` or

`helm upgrade --install hp-dashboard holisticpay/hp-dashboard --set required-key1=value1 --set required-key2=value2 ...`
