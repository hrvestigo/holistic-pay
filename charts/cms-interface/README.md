...
datasource:
  ...
  schema: "database-schema" # PostgreSQL schema for CMS interface application
```
...
If outbound resources (Kafka or CMS) require TLS connection, trust store with required certificates should also be provided.
